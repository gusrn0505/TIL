...
def MNIST_train(args, model, device, labeled_dataset, labeled_dataset_label, optimizer, epoch):
    model.train()
...
def MNIST_test(args, model, device, test_dataset, test_dataset_label, optimizer1, epoch) :
    model.eval()
    test_loss = 0
    correct = 0
...
def CIFAR_train(args, model, device, labeled_dataset, labeled_dataset_label, optimizer, epoch):
    model.train()
...
def CIFAR_test(args, model, device, test_dataset, test_dataset_label, optimizer1, epoch) :
    model.eval()
    test_loss = 0
    correct = 0
