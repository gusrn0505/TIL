...
base_root='/home/test/yesung/chicken/preprocessed'
...
print('val_recall is',val_recall)
print('val_best_recall_threshold', val_best_recall_threshold)
print('val_auc',val_auc)
print('val_auprc',val_auprc)
