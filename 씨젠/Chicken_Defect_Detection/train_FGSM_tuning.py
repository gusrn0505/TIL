...
def parameter_tuning(epsilon) : 
    ...
    for epoch in range(epoch):
        ...
        ## train 학습 수행
        epoch_loss, disc_loss, gen_loss=U.Train(train_loader, models, criterions, optimizers,epsilon,device=device, log=log, args=args)
        if (args.optim=='SGD'):
...
def main_worker(args): 
    ...
    #base_root='/home/test/Jupyter_lab_folder/hdd/Dataset/chicken/Dataset/preprocessed/classification'
    base_root='/home/test/Jupyter_lab_folder/hdd/Dataset/chicken/Dataset/preprocessed2'
