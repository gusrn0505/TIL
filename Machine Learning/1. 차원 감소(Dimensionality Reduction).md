...
- ###### 목적 : 기본 데이터의 "거리"를 최대한 보존하는 축을 찾자.
...
### 3. ISOMAP & LLE - for non-linear case



##### ISOMAP(Isometric Feature Mapping) 의의
...
##### LLE(Locally Linear Embedding) 의의

1. 적용하기 쉬움 

2. 최적해 탐색 간 local minima 미포함 

3. highyl nonlinear emdedding 가능. (정확히 무슨 의미일까)
