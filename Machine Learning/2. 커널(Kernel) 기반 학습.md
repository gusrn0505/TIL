...
2. Kernel 함수가 positive semi-definite 여야 하는 이유 
...
- **KKT(Karush-kuhn-Tucker) 조건**
  ...
  - 라그랑주 승수를 통한 최적해 계산 간 부등식 제약 조건이 있을시 성립해야하는 조건
    
    > (1) 라그랑주 승수인  $\alpha_i$는  0보다 같거나 크다 
    > 
    > (2) 제약식은 0보다 같거나 크다. 
    > 
    > - ex)- $y_if(x_i) -1 >=0$ 
    > 
    > (3) 라그랑주 승수와 제약식의 곱은 0이나, 둘다 0이 되서는 안된다. 
...
- ##### 커널 함수의 조건
  ...
  2. Positive semi-definite 여야 한다. (why?)
